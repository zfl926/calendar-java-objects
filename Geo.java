...
public class Geo
{
    ...
    */
    ...
    class CoordinateManager {
       ...
       */
      public float EARTH_DIAMETER = Float.valueOf("12756.274");
       ...
       */
      public double longitudeConstant(float latitude) {
       ...
       */
      public Coordinate addDistanceNorth(float latitude, float longitude, int distance) {
       ...
       * @return          the new coordinate
       */
      public Coordinate addDistanceSouth(float latitude, float longitude, int distance) {
       ...
       * @return          the new coordinate
       */
      public Coordinate addDistanceEast(float latitude, float longitude, int distance) {
       ...
       * @return          the new coordinate
       */
      public Coordinate addDistanceWest(float latitude, float longitude, int distance) {
       ...
       */
      public java.util.HashMap<String, Coordinate> getBoundingBox(float latitude, float longitude, int distance) {
